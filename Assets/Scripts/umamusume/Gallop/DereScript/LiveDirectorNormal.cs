...
public class LiveDirectorNormal : LiveDirector
{
    ...
    private static Master3dLive master3dLive = null;
    ...
    public LiveDirectorNormal(SQMusicData data)
    {
        liveData = data;
    ...
    public string cyalumeFile
    {
        get
        {
            ...
            if (live3DData != null)
            {
                filename = string.Format("3d_cyalume_m{0:D03}.unity3d", live3DData.id);
                filename = filename.ToLower();
            }
            return filename;
        }
    ...
    public string stageFile
    {
        get
        {
            ...
            if (live3DData != null)
            {
                filename = string.Format("3d_stage_{0:0000}.unity3d", live3DData.bg);
            }
            filename = filename.ToLower();
            return filename;
        }
