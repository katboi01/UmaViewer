...
namespace RootMotion.Dynamics {
	...
	public class BipedRagdollCreator : RagdollCreator {
		...
		private static void CreateJoints(BipedRagdollReferences r, Options o) {
			...
			// Arms
			CreateJointParams.Limits upperArmLimits = new CreateJointParams.Limits(-50f * o.jointRange, 30f * o.jointRange, 177f * o.jointRange, 30 * o.jointRange);
			CreateJointParams.Limits lowerArmLimits = new CreateJointParams.Limits(0f, 100f * o.jointRange, 10f * o.jointRange, 45f * o.jointRange);
			CreateJointParams.Limits handLimits = new CreateJointParams.Limits(-30f * o.jointRange, 30f * o.jointRange, 30f * o.jointRange, 25f * o.jointRange);
			...
			// Legs
			CreateJointParams.Limits upperLegLimits = new CreateJointParams.Limits(0f * o.jointRange, 177f * o.jointRange, 25f * o.jointRange, 25 * o.jointRange);
			CreateJointParams.Limits lowerLegLimits = new CreateJointParams.Limits(0f, 100f * o.jointRange, 10f * o.jointRange, 35f * o.jointRange);
			CreateJointParams.Limits footLimits = new CreateJointParams.Limits(-30f * o.jointRange, 30f * o.jointRange, 30f * o.jointRange, 25f * o.jointRange);
