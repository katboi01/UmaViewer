...
namespace LibMMD.Unity3D.ImageLoader
{
    ...
    public class TargaImage
    {
        ...
        private void LoadTGAImage(BinaryReader binReader)
        {
            ...
            {
                bmpTargaImage = new Texture2D(objTargaHeader.Width, objTargaHeader.Height);
                bmpTargaImage.SetPixels(Utils.Bgra32ToColors(bimagedata));
            }
            else
            {
                bmpTargaImage = new Texture2D(objTargaHeader.Width, objTargaHeader.Height, pf, false);
