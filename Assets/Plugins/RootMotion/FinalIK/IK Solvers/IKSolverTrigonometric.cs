...
namespace RootMotion.FinalIK
{
    ...
    public class IKSolverTrigonometric : IKSolver
    {
        ...
        {
            return new IKSolver.Point[3] { bone1, bone2, bone3 };
        }

        public override IKSolver.Point GetPoint(Transform transform)
        {
            if (bone1.transform == transform) return bone1;
            if (bone2.transform == transform) return bone2;
            if (bone3.transform == transform) return bone3;
            return null;
        }
