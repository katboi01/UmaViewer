...
namespace RootMotion.Dynamics
{
    ...
    public class CharacterJointInspector : JointInspector
    {
        ...
        public static void DrawJoint(CharacterJoint joint, bool modifiable = true, float alphaMlp = 1f)
        {
            ...
            float newLowTwistLimit = DrawJointLimit(joint, "Low Twist Limit", axis, joint.lowTwistLimit.limit, MlpAlpha(lowTwistColor, alphaMlp), -25, modifiable);
            ...
            if (newLowTwistLimit != 0 || (newLowTwistLimit == 0 && newHighTwistLimit != 0)) newHighTwistLimit = DrawJointLimit(joint, "High Twist Limit", axis, joint.highTwistLimit.limit, MlpAlpha(highTwistColor, alphaMlp), 25, modifiable);
            joint.highTwistLimit = NewJointLimit(newHighTwistLimit, joint.highTwistLimit, -180, 180);

            float newSwing1Limit = DrawJointLimit(joint, "Swing1 Limit", swingAxis, -joint.swing1Limit.limit, MlpAlpha(swing1Color, alphaMlp), 25, false);
            newSwing1Limit = DrawJointLimit(joint, "Swing1 Limit", swingAxis, -newSwing1Limit, MlpAlpha(swing1Color, alphaMlp), 25, modifiable);
            joint.swing1Limit = NewJointLimit(newSwing1Limit, joint.swing1Limit, 0, 180);

            float newSwing2Limit = DrawJointLimit(joint, "Swing2 Limit", crossAxis, -joint.swing2Limit.limit, MlpAlpha(swing2Color, alphaMlp), 25, false);
            newSwing2Limit = DrawJointLimit(joint, "Swing2 Limit", crossAxis, -newSwing2Limit, MlpAlpha(swing2Color, alphaMlp), 25, modifiable);
